...
#if defined _DEBUG
#pragma comment(lib, "./lib/libMinHook-x86-v141-mtd.lib")
#else
#pragma comment(lib, "./lib/libMinHook-x86-v141-mt.lib")
#endif
#endif
